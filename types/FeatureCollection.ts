...
// To parse this data:
//
//   import { Convert, FeatureCollection } from "./file";
//
//   const featureCollection = Convert.toFeatureCollection(json);
//
...
export class Convert {
  public static toFeatureCollection(json: string): FeatureCollection {
    return cast(JSON.parse(json), r("FeatureCollection"));
  }

  public static featureCollectionToJson(value: FeatureCollection): string {
    return JSON.stringify(uncast(value, r("FeatureCollection")), null, 2);
  }
}
...
const typeMap: any = {
  "FeatureCollection": o([
    ...
    { json: "type", js: "type", typ: r("FeatureCollectionType") },
  ], "any"),
  "GeoJSONFeature": o([
    { json: "bbox", js: "bbox", typ: u(undefined, a(3.14)) },
